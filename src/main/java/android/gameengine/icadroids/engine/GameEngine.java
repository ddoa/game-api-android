...
public abstract class GameEngine extends Activity implements SensorEventListener {
     ...
     *
     * @param a The alarm to be deleted.
     */
     ...
     * @param x             The X spawnlocation when this object is created
     * @param y             The Y spawnlocation when this object is created
     * @param layerposition The layerposition when this object is drawed. <b>Between 0 and
     ...
     * tilemaps fit.
     *
     * @param gameTiles the current gameTiles object.
     */
     ...
     *
     * @param pattern the pattern is an array of milliseconds. the first value in
     ...
     * player.
     *
     * @param player The player that should be added to the game. The location of
     ...
     *
     * @param hpositioning the horizontal postioning, or Viewport.PLAYER_NOADJUST if there is no horizontal
     *                     adjustment of the viewport
     * @param vpositioning the vertical postioning, or Viewport.PLAYER_NOADJUST if there is no vertical
     *                     adjustment of the viewport
     */
     ...
     *
     * @param type the class name with .class behind it.
     ...
     *
     * @param rectangle the rectangle specified in a left, top to bottom,right
     *                  location
     ...
     *
     * @param landscape true if landscape screen is required, false if not
     */
     ...
     * including range.
     *
     * @param range the maximum number that may be returned

...
public class GameView extends SurfaceView implements Callback {
     ...
     *
     * @param ge         The Game Engine that this GameRenderer is part of.
     * @param gameThread The thread that this renderer will use.
     */
     ...
     *
     * @param canvas The canvas used to draw the background image
     */
     ...
     *
     * @param backgroundString The name of the image that will be used as background.
     */
     ...
     *
     * @param zoomFactor The amount of zooming
     */

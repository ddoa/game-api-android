...
public class Viewport {
     ...
     *
     * @param context The context that provides additional information for the
     *                viewport
     * @param ge      The Game Engine that this viewport is part of
     */
    private Viewport() {
        // Singleton
    }
     ...
     *
     * @param player The object that will act as a player
     */
     ...
     *
     * @param minX the minimal horizontal coordinate
     * @param minY the minimal vertical coordinate
     * @param maxX the maximal horizontal coordinate
     * @param maxY the maximal vertical coordinate
     */
     ...
     *
     * @param hpositioning the horizontal postioning, or zero if there is no horizontal
     *                     adjustment of the viewport
     * @param vpositioning the vertical postioning, or zero if there is no vertical
     *                     adjustment of the viewport
     */
     ...
     * viewport in further.
     *
     * @param zoomFactor the zoomfactor for the viewport.
     */
     ...
     *
     * @param item the gameitem that needs to be checked

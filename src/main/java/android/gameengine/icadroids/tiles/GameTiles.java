...
public class GameTiles {
     ...
     * the tile size
     *
     * @param tileResources a list of string with the names of the images you want to use
     *                      in the tilemap. This images have only the name of the images
     *                      without the extension! For example: new String[] = {"tile1",
     *                      "tile2", "tile3"};
     * @param map           An 2d Array of the overlay map. The numbers are the position
     *                      of the tileResources, starting at 0. -1 means invisible Tile.
     *                      Example: new Int[][] = {{0,-1,2,2,-1},{1,1,-1,2,-1}}
     * @param tileSize      The size of a tile. This size is the width and height of a
     *                      tile.
     */
     ...
     *
     * @param yTile    the y-pos of the tile in the tile array
     * @param xTile    the y-pos of the tile in the tile array
     * @param tileType the new sprite type that should replace this tile
     */
     ...
     *
     * @param resourceNames all resources you want to add to the list
     */
     ...
     *
     * @param tileArray the 2d array to calculate the size
     */

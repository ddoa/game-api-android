...
public class MoveableGameObject extends GameObject {
     ...
     *
     * @param speed the speed to give this object.
     */
     ...
     *
     * @param x_movement the amount of X pixels this object should move.
     * @param y_movement the amount of Y pixels this object should move.
     */
     ...
     * vertical direction.
     *
     * @param horizontal Put this on TRUE if you want to bounce Horizontal, FALSE if
     ...
     *
     * @param directionSpeed the current speed
     ...
     * class.
     *
     * @param objectClass Asks for any generic class, classes you should use are
    ...
    public void moveUpToTileSide(TileCollision tc) {
        ...
        int pos;
        if (side == 0 || side == 2) {    // move to horizontal tile edge, top or bottom
            pos = tc.theTile.getTileY();
            if (side == 2) {    // bottom, add gridsize to pos
                pos = pos + GameEngine.gameTiles.tileSize;
            } else {    // top of tile, adapt for sprite height
        ...
        } else {    // move to vertical tile edge, left or right
            pos = tc.theTile.getTileX();
            if (side == 1) {    // right, add gridsize to pos
                pos = pos + GameEngine.gameTiles.tileSize;
            } else {

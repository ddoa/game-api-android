...
public class AnimatedSprite extends Sprite {
     ...
     * Detection!</b>
     *
     * @param resourceName   The name of the resource in the /res/drawable folder <b>
     *                       without extension </b>, so when your picture in the
     *                       /res/drawable is named 'picture.jpg', this parameter should be
     *                       "picture" .
     * @param numberOfFrames The number of frames in the strip
     */
     ...
     *
     * @param frameNumber The frame number to jump to
     */
     ...
     * sprite
     *
     * @param frameNumber The framenumber to calculate
     */
     ...
     *
     * @param animationSpeed How many update must occur before going to the next frame. So
     ...
     *
     * @see android.gameengine.icadroids.objects.graphics.Sprite#getSpriteCenterX()
     */
    @Override
     ...
     *
     * @see android.gameengine.icadroids.objects.graphics.Sprite#getSpriteCenterY()
     */
    @Override

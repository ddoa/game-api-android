...
public class GameObject {
     ...
     *
     * @return boolean indicating if this object still is in the game
     */
     ...
     *
     * @return boolean indicating if this object still is visible
     */
     ...
     *
     * @param theSprite AnimatedSprite that has been created earlier
     */
     ...
     *
     * @param speed The number of game loops that must occur before the next
     ...
     *
     * @param number The frame number, frame numbers range from 0 to NrOfFrames-1
     */

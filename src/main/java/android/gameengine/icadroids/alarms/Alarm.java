...
public class Alarm {
     ...
     *
     * @param id            ID to identify the alarm
     * @param Time          How many updates must occur before the alarm goes off
     * @param alarmedObject The object that must be informed when the alarm goes off
     */
     ...
     *
     * @param ia The object you want want to test
     * @return true if this Alarm is set for the specified object
     */

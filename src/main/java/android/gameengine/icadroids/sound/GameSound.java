...
public final class GameSound {
     ...
     * function.
     *
     * @param index   The sound index where the sound will be stored.
     * @param soundID The name of the sound that needs to be stored.
     */
     ...
     *
     * @param index     The Index of the Sound to be played, defined by addSound.
     * @param loopSound The amount of times the music should loop, a negative value
     ...
     *
     * @param index index of the sound to be paused.
     */
     ...
     *
     * @param index index of the sound to be resumed
     */

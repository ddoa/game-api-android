...
public class OnScreenButtons {
    ...
    public static boolean
            /** This static var is TRUE when input has been detected on the up key of the dpad. */
            dPadUp,
    /**
     * This static var is TRUE when input has been detected on the down key of the dpad.
     */
    dPadDown,
    /**
     * This static var is TRUE when input has been detected on the left key of the dpad.
     */
    dPadLeft,
    /**
     * This static var is TRUE when input has been detected on the right key of the dpad.
     */
    dPadRight,
    /**
     * This static var is TRUE when input has been detected on button A.
     */
    buttonA,
    /**
     * This static var is TRUE when input has been detected on button B.
     */
    buttonB,
    /**
     * This static var is TRUE when input has been detected on button X.
     */
    buttonX,
    /**
     * This static var is TRUE when input has been detected on button Y.
     */
    buttonY,
    /**
     * This static var is TRUE when input has been detected on button 'start'.
     */
    start,
    /**
     * This static var is TRUE when input has been detected on button 'select'.
     */
    select;
     ...
     * top of the canvas.
     *
     * @param gameEngine : The context is required by this class so it can receive the
     ...
     *
     * @param buttonId The layout id of the button
     */
     ...
     *
     * @param buttonId The id of the button that has been pressed
     ...
     *
     * @param buttonId The id of the button that needs to be dissabled. you can get

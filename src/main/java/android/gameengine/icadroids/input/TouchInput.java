...
public class TouchInput implements OnTouchListener {
     ...
     *
     * @param v     the View that android requires
     * @param event the event that this function catches.
     */
     ...
     *
     * @param event the event to pass to this function
     ...
     *
     * @param e the event to pass to this function.
     */
